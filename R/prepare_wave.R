...
#' @param custom_ccode_to_cntry A set of custom values mapping country names
#' to country codes (see details).
#' @param custom_cntry_to_ccode A set of custom values mapping country codes
...
prepare_wave <- function(
    ...
    custom_ccode_to_cntry = c("Germany-East - D-E" = "DE",
                              "Germany-West - D-W" = "DE",
                              "D-E-Germany-East" = "DE",
                              "D-W-Germany-West" = "DE"),
    ...
    output <- input |> 
        ...
        mutate(
            ...
            cntry = countrycode::countrycode(
                ...
                nomatch = NULL,
                # Since we exclude Northern Ireland, hard code United Kingdom
                # as Great Britain
